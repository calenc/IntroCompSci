/**
 * ------------------------------------------------------------------------------------------
 * File Name: InternetSPE.java
 * Project Name: Internet Service Provider Part 2
 * ------------------------------------------------------------------------------------------
...
public class InternetSPE
{
	 ...
	 */
	 public static void main(String[] args)
	 {
		...
		double fullA; 	// This is the full service plan when hours > 10
		double fullB;	// This is the full service plan when hours > 20
		...
		switch (pkg)
		{
			case "A":
				...
				{
					System.out.println("With this plan and these hours, you spend $" + (flatA + extraA) + " per month.");
					System.out.print("If you had Package B, you would have saved $" + (fullA - flatB) + " this month.");
				}
				else if (hours > 15 && hours <= 20)
				{
					System.out.println("With this plan and these hours, you spend $" + (flatA + extraA) + " per month.");
					System.out.println("If you had Package B, you would have saved $" + (fullA - flatB) + " this month.");
					System.out.print("If you had Package C, you would have saved $" + (fullA - flatC) + " this month.");
				}
				else if (hours > 20)
				{
					System.out.println("With this plan and these hours, you spend $" + (flatA + extraA) + " per month.");
					System.out.println("If you had Package B, you would have saved $" + (fullA - fullB) + " this month.");
					System.out.print("If you had Package C, you would have saved $" + (fullA - flatC) + " this month.");
				}
				else	
			...
			case "B": 
				...
				{
					System.out.println("With this plan and these hours, you spend $" + (flatB + extraB) + " per month.");
					System.out.print("If you had Package C, you would have saved $" + (fullB - flatC) + " this month.");
				}
				else
